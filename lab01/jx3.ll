...
define i32 @_Z3jiei(i32) local_unnamed_addr #3 {
  %2 = icmp slt i32 %0, 2
...
; <label>:7:                                      ; preds = %3, %4
  ...
  %9 = phi i32 [ %10, %4 ], [ 1, %3 ]
  %10 = mul nsw i32 %8, %9
  %11 = icmp ugt i32 %10, 9999
  br i1 %11, label %12, label %4

; <label>:12:                                     ; preds = %4, %7, %1
  %13 = phi i32 [ 1, %1 ], [ %10, %7 ], [ %10, %4 ]
  ret i32 %13
}
...
define i32 @main() local_unnamed_addr #5 {
  ...
  %2 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0))
...
; <label>:11:                                     ; preds = %7, %8
  ...
  %15 = icmp ugt i32 %14, 9999
  br i1 %15, label %16, label %8

; <label>:16:                                     ; preds = %8, %11, %0
  %17 = phi i32 [ 1, %0 ], [ %14, %11 ], [ %14, %8 ]
...
; Function Attrs: nounwind
declare i32 @scanf(i8* nocapture readonly, ...) local_unnamed_addr #1

; Function Attrs: uwtable
define internal void @_GLOBAL__sub_I_jx.cpp() #6 section ".text.startup" {
